...
def get_parser(parser=None, required=True):
    ...
    parser.add_argument(
        "--econformer_kernel_size", type=int, default=0, help="Conformer convolution size in encoder."
    )
    parser.add_argument(
        "--eposition_embedding_type", type=str, default='absolute', help="Positional embedding class for encoder"
    )
